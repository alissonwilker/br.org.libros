package br.org.libros.comum.view.utils;
...
public class FacesMessageUtils {
	...
	/**
	 * Adiciona um mensagem de informação a partir da chave e parâmetros que devem ser recuperados do bundle de mensagens.
	 * @param key chave da mensagem no bundle de mensagens.
	 * @param parameters parâmetros para formatar a mensagem parametrizada.
	 */
	...
	/**
	 * Recupera uma mensagem formatada do bundle de mensagens e retorna como uma FacesMessage informativa.
	 * @param key chave da mensagem no bundle de mensagens.
	 * @param parameters parâmetros para formatar a mensagem parametrizada.
